class IWADsMonsters_UltimateDoom_E1M7 : LevelPostProcessor
{
	static void PlaceMonsters() // 9007F68E7F351A5758198933336F6B9F - Ultimate Doom E1M7: Computer Station
    {
		...
		if (skill_level >= 3)
		{
			actor Revenant1 = Actor.Spawn("Revenant", (-952.0,-1280.0,48.0), ALLOW_REPLACE); //need to move from y:-1384
			Revenant1.Angle = 270.0;
			Revenant1.bAmbush = True;
			
			actor Revenant2 = Actor.Spawn("Revenant", (424.0,-2176.0,56.0), ALLOW_REPLACE);
		...
		if (union_nightmare_imps_placement)
		{
			...
			actor NightmareDoomImp12 = Actor.Spawn("NightmareDoomImp", (1088.0,-336.0,0.0), ALLOW_REPLACE); //133
		...
		if ((skill_level >= 2)&&(union_nightmare_imps_placement))
		{
			...
			actor NightmareDoomImp2 = Actor.Spawn("NightmareDoomImp", (384.0,192.0,0.0), ALLOW_REPLACE); //162
			NightmareDoomImp2.Angle = 135.0;
			
			actor NightmareDoomImp3 = Actor.Spawn("NightmareDoomImp", (-896.0,320.0,0.0), ALLOW_REPLACE); //172
			NightmareDoomImp3.Angle = 180.0;
			
			actor NightmareDoomImp4 = Actor.Spawn("NightmareDoomImp", (-928.0,208.0,0.0), ALLOW_REPLACE); //173
			NightmareDoomImp4.Angle = 270.0;
			NightmareDoomImp4.bAmbush = True;
			
			actor NightmareDoomImp5 = Actor.Spawn("NightmareDoomImp", (448.0,-640.0,0.0), ALLOW_REPLACE); //155
			NightmareDoomImp5.Angle = 0.0;
			
			actor NightmareDoomImp6 = Actor.Spawn("NightmareDoomImp", (320.0,-1024.0,0.0), ALLOW_REPLACE); //154
			NightmareDoomImp6.Angle = 180.0;
			
			actor NightmareDoomImp7 = Actor.Spawn("NightmareDoomImp", (288.0,-1328.0,0.0), ALLOW_REPLACE); //35
			NightmareDoomImp7.Angle = 90.0;
			
			actor NightmareDoomImp9 = Actor.Spawn("NightmareDoomImp", (80.0,-1744.0,0.0), ALLOW_REPLACE); //50
			NightmareDoomImp9.Angle = 0.0;
			
			actor NightmareDoomImp10 = Actor.Spawn("NightmareDoomImp", (1600.0,-2304.0,56.0), ALLOW_REPLACE); //60
			NightmareDoomImp10.Angle = 180.0;
			
			actor NightmareDoomImp11 = Actor.Spawn("NightmareDoomImp", (-1408.0,416.0,152.0), ALLOW_REPLACE); //226
