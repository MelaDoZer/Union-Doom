class IWADsMonsters_UltimateDoom_E2M3 : LevelCompatibility
{
	static void PlaceMonsters() // 918436B3C2D0AD4F2C108183414B4612 - Ultimate Doom E2M3: Refinery
    {
    ...
    {
        if ((union_psx_nightmare_spectres_placement) && ('918436B3C2D0AD4F2C108183414B4612' == checksum)) // - Ultimate Doom E2M3: Refinery
        {
            SetThingFlags(202, 0);
        }
        

        if ((union_nightmare_imps_placement) && ('918436B3C2D0AD4F2C108183414B4612' == checksum)) // - Ultimate Doom E2M3: Refinery
        {
            SetThingFlags(119, 0);
            SetThingFlags(120, 0);
            SetThingFlags(207, 0);
