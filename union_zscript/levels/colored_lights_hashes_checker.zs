class UnionDoom_Colored_Lights play
{
	...
	static void CheckMapHashes()
	{
		...
		if(LevelChecksum == 'B49F7A6C519757D390D52667DB7D8793') // - Ultimate Doom E1M1: Hangar
		UltimateDoomE1M1ColoredLights();
			
		else if(LevelChecksum == '81A4CC5136CBFA49345654190A626C09') // - Ultimate Doom E1M2: Nuclear Plant
		...
		else if(LevelChecksum == 'EFFE91DF41AD41F6973C06F0AD67DDB9') // - Ultimate Doom E2M8: Tower of Babel (it's map23 (e3m8) in PS1)
		...
		else if(LevelChecksum == '4A4832BEBE16A3D56912490A4E61F59B') // - Sigil E5M1: Baphomet's Demesne (v. 1.21)
		SigilE5M1ColoredLights();
		
		else if(LevelChecksum == '38028DC7E09DC5C91068AAC565A3962B') // - Sigil E5M2: Sheol (v. 1.21)
