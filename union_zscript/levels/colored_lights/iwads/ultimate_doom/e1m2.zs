...
class ColoredLights_UltimateDoom_E1M2: LevelCompatibility
{
	protected void Apply(Name checksum, String mapname)
	{
		if ((union_colored_lighting) && ('81A4CC5136CBFA49345654190A626C09' == checksum)) // - Ultimate Doom E1M1: Hangar
		{
			//Start Room
			...
			//Acid Areas of Map
			Level.Sectors[39].SetColor("55B828", 0);
			Level.Sectors[141].SetColor("55B828", 0);
			Level.Sectors[144].SetColor("55B828", 0);
			Level.Sectors[163].SetColor("55B828", 0);
			
			//Near Acid Areas of Map
			Level.Sectors[40].SetColor("BBE357", 0);
			Level.Sectors[41].SetColor("BBE357", 0);
			Level.Sectors[142].SetColor("BBE357", 0);
			...
			Level.Sectors[49].SetColor("FF7F7F", 0);
			Level.Sectors[51].SetColor("FF7F7F", 0);
		}
	}
}