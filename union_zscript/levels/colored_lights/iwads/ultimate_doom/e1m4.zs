...
class ColoredLights_UltimateDoom_E1M4: LevelCompatibility
{
	protected void Apply(Name checksum, String mapname)
	{
		if ((union_colored_lighting) && ('5B26545FF21B051CA06D389CE535684C' == checksum)) //- Ultimate Doom E1M4: Command Control
		{
			//Acid River
			Level.Sectors[95].SetColor("55B828", 0);
			Level.Sectors[98].SetColor("55B828", 0);
			Level.Sectors[110].SetColor("55B828", 0);
			...
			Level.Sectors[7].SetColor("BBE357", 0);
			Level.Sectors[107].SetColor("BBE357", 0);
			Level.Sectors[135].SetColor("BBE357", 0);
			
			//Acid Pool
			Level.Sectors[42].SetColor("55B828", 0);
			
			//Near Acid Pool - Stairs
			Level.Sectors[43].SetColor("BBE357", 0);
			Level.Sectors[44].SetColor("BBE357", 0);
			Level.Sectors[47].SetColor("BBE357", 0);
			...
			//Exit
			Level.Sectors[57].SetColor("FF7F7F", 0);
		}
	}
}